 ...
 *
 * Path: /orgs/[slug]/i3/teams/[team_id]/equipment-kinds/[kind_id]
 */
"use client";
...
export default function I3Module_Team_EquipmentKindItems_Page(
    props: PageProps<"/orgs/[slug]/i3/teams/[team_id]/equipment-kinds/[kind_id]">,
) {
            ...
            <Std.Navbar
                breadcrumbs={[
                    ...
                    },
                    {
                        ...
                        href: route("/orgs/[slug]/i3/teams/[team_id]/equipment-kinds", {
                            slug: organization.slug,
                            team_id,
                        }),
                    },
