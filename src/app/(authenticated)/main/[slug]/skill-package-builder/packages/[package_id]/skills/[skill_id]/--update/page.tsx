 ...
 *
 * Paths: /main/[slug]/skill-package-builder/packages/[package_id]/skills/[skill_id]/--update
 */
"use client";
...
export default function SkillPackageBuilder_UpdateSkill_Page(
    props: PageProps<`/main/[slug]/skill-package-builder/packages/[package_id]/skills/[skill_id]/--update`>,
) {
            ...
            <Lexington.Header
                breadcrumbs={[
                    ...
                    "Skills",
                    {
                        ...
                        href: route(
                            "/main/[slug]/skill-package-builder/packages/[package_id]/skills/[skill_id]",
                            { slug, package_id: skill.skillPackageId, skill_id: skill.id },
                        ),
                    },
                    "Update",
                ]}
