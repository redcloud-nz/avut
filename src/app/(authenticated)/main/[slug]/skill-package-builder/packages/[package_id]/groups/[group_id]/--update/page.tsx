 ...
 *
 * Paths: /main/[slug]/skill-package-builder/packages/[package_id]/groups/[group_id]/--update
 */
"use client";
...
export default function SkillPackageBuilder_UpdateGroup_Page(
    props: PageProps<`/main/[slug]/skill-package-builder/packages/[package_id]/groups/[group_id]/--update`>,
) {
