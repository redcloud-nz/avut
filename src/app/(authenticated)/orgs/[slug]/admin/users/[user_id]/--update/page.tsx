 ...
 *
 * Paths: /orgs/[slug]/admin/users/[user_id]/--update
 */
"use client";
...
export default function AdminModule_UpdateUser_Page(
    props: PageProps<`/orgs/[slug]/admin/users/[user_id]/--update`>,
) {
    ...
    const mutation = useMutation({
        ...
        onSuccess: async () => {
            ...
            router.push(
                Paths.org(organization.slug).admin.user(
            ...
            <Lexington.Header
                breadcrumbs={[
                    ...
                    Paths.org(slug).admin.users,
                    {
                        ...
                        href: Paths.org(slug).admin.user(user_id).href,
                    },
                    "Update",
                ]}
            />
            <Lexington.Page>
                <Lexington.Column width="lg">
                    <Hermes.Section>
                        <Hermes.Header>
                            <Hermes.BackButton
                                to={Paths.org(slug).admin.user(user_id)}
