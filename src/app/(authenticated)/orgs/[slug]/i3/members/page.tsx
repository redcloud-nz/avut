...
export default async function I3Module_MembersList_SelectTeam_Page(
    props: PageProps<"/orgs/[slug]/i3/members">,
) {
    ...
    if (d4HTeams.length == 1) {
        redirect(
            route("/orgs/[slug]/i3/teams/[team_id]/members", {
            ...
            <Std.ScrollContainer>
                <Saratoga.Root>
                    ...
                    <p className="text-sm text-muted-foreground">
                        You have multiple teams available. Please select a team to view its members.
                    </p>
                    <ItemGroup>
                        {d4HTeams
