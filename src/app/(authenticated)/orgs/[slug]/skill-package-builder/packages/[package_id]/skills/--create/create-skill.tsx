...
interface SkillPackageBuilder_CreateSkill_FormProps {
    skillPackage: SkillPackage;
    skillGroup: SkillGroup | null;
}

export function SkillPackageBuilder_CreateSkill_Form({
    skillPackage,
    skillGroup,
}: SkillPackageBuilder_CreateSkill_FormProps) {
                ...
                <form id="create-skill-form" onSubmit={handleCreate}>
                    <FieldGroup>
                        ...
                        <Field orientation="horizontal">
                            <Button type="submit" form="create-skill-form">
                                Create
                            </Button>
                            <Button
                                type="button"
