 ...
 *
 * Paths: /orgs/[slug]/skill-package-builder/packages/[package_id]/contents
 */

import { Metadata } from "next";

import { SkillPackageBuilder_PackageContents_Content } from "@/components/skill-package-builder/package-contents-content";
...
export async function generateMetadata(props: Props): Promise<Metadata> {
    ...
    return { title: `${skillPackage.name} Contents ${TITLE_SEPARATOR} Skill Package Builder` };
}
...
export default async function SkillPackageBuilder_PackageContents_Page(props: Props) {
    ...
    return (
        <HydrateClient>
            <Std.SidebarInset>
                <SkillPackageBuilder_PackageContents_Content skillPackageId={skillPackageId} />
            </Std.SidebarInset>
        </HydrateClient>
    );
}
