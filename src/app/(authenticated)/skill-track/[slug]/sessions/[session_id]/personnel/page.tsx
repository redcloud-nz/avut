 ...
 *
 * Path: /skill-track/[slug]/sessions/[session_id]/personnel
 */
...
export default function SkillTrack_SessionPersonnel_Page(
    props: PageProps<"/skill-track/[slug]/sessions/[session_id]/personnel">,
) {
            ...
            <Std.Navbar>
                <Std.Breadcrumbs
                    breadcrumbs={[
                        ...
                        {
                            label: "Sessions",
                            href: route("/skill-track/[slug]/sessions", { slug }),
                        },
                        {
                            label: session.name,
                            href: route("/skill-track/[slug]/sessions/[session_id]", {
                                slug,
                                session_id,
                            }),
                        },
