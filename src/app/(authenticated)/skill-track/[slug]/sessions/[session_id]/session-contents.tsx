        ...
        <Card>
            ...
            <CardContent className="px-2 -my-2">
                <Item size="sm" asChild>
                    <Link
                        href={route("/skill-track/[slug]/sessions/[session_id]/personnel", {
                ...
                <Item size="sm" asChild>
                    <Link
                        href={route("/skill-track/[slug]/sessions/[session_id]/skills", {
                            slug: organization.slug,
                            session_id: sessionId,
                        })}
                    >
                ...
                <Item size="sm" asChild>
                    <Link
                        href={route("/skill-track/[slug]/sessions/[session_id]/checks", {
                            slug: organization.slug,
                            session_id: sessionId,
                        })}
                    >
