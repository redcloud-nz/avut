...
import { EyeIcon, SquareArrowRightEnterIcon, SquareArrowRightExitIcon } from "lucide-react";
...
export async function generateMetadata(props: LayoutProps<"/i3/[slug]">): Promise<Metadata> {
    const { slug } = await props.params;
    const organization = await getOrganizationBySlug(slug);

    return {
        title: `I3 ${TITLE_SEPARATOR} ${organization.name}`,
    };
}
