...
export function AdminModule_ArchivePerson_Dialog({
    person,
    ...props
    ...
    const mutation = useMutation(
        trpc.personnel.archivePerson.mutationOptions({
            ...
            onSuccess() {
                toast.success(
                    <>
                        Person <ObjectName>{person.name}</ObjectName> archived.
                    </>,
                );
        ...
        <Dialog {...props}>
            <DialogContent onCloseAutoFocus={(e) => e.preventDefault()}>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Archive <ObjectName>{person.name}</ObjectName>. They stay on their teams and
                        keep their history, but drop out of the default Active personnel filter. You
