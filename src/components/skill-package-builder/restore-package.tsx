...
export function SkillPackageBuilder_RestorePackage_Dialog({
    skillPackage,
}: {
    ...
    const mutation = useMutation(
        trpc.skillPackageBuilder.restorePackage.mutationOptions({
            ...
            onError(error) {
                ...
                toast.error(`Failed to restore package: ${error.message}`);
            },
            onSuccess() {
                toast.success(
                    <>
                        Package <ObjectName>{skillPackage.name}</ObjectName> restored.
                    </>,
                );
